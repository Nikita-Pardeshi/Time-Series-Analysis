...
# Ljung-Box test to check for correlations between lags
...
The next step is to identify the level of correlation between the series and it’s lags, using the acf function:
